          ...
          <Grid item>
            ...
            >
              {Object.keys(textByLine).map((key) => {
                ...
                const height = (blPoint.y - tlPoint.y) / container.height;
                const top = tlPoint.y / container.height;
                const left = tlPoint.x / container.width;
                ...
                return (
                  ...
                  >
                    {row.map((word) => (
                      <span className={styles.word}>{word.description}</span>
                    ))}
                  </div>
                );
              })}
