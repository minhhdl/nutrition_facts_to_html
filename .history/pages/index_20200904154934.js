    ...
    const html = ReactDOMServer.renderToStaticMarkup(
      ...
      >
        {Object.keys(textByLine).map((key) => {
          ...
          const [tlPoint, trPoint, brPoint, blPoint] = vertices;
          const height =
            (((blPoint.y - tlPoint.y) * heightRatio) / container.height) * 100;
          const top = ((tlPoint.y * heightRatio) / container.height) * 100;
          const left = ((tlPoint.x * widthRatio) / container.width) * 100;
