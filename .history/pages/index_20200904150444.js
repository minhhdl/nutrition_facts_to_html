...
export default function Home() {
  ...
  const convertHtml = () => {
    ...
    const widthRatio =
      imageRef?.current.clientWidth > container.width
        ? imageRef?.current.clientWidth / container.width
        : container.width / imageRef?.current.clientWidth;
    
    const widthByRatio = container.width * widthRatio;
    const heightByRatio = (container.width * widthRatio) / containerRatio;

    console.log(imageRef?.current.clientWidth, widthRatio, widthByRatio, heightByRatio container.width, container.height, containerRatio);
