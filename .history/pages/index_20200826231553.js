  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        >
          {textAnnotations.slice(1).map((item) => {
            ...
            return (
              <div style={{ width, height, position: 'absolute', top, left }}>
                {/* <ReactFittext compressor={1} minFontSize={height}> */}
                <span style={{ fontSize: height }}>{item.description}</span>
                {/* </ReactFittext> */}
              </div>
            );
          })}
